...
const Header = () => {
  ...
  const handleScroll = (offset: any) => {
    ...
    if (
      (document.body.scrollTop > 200 && document.body.scrollTop < 1000) ||
  ...
  return (
    <div
      ref={header}
      className="fixed top-0 left-0 right-0 z-40 nav-smooth text-white"
    >
      <div className="mx-8">
        <div
          id="header"
          className="flex relative mx-auto py-4 px-5 shadow-xl width_1300 bg_landing"
        >
